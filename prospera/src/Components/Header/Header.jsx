...
const Header = ({ open, setOpen }) => {
    ...
    useEffect(() => {
        ...
        //Google Translate API function to that obtains the translate object and initializes the google translate element
    ...
    return (
        <div className='mainHeader'>
            {/* Dynamic header that changes based on logged in user or not */}
            {isLoggedIn ? (
                <>
